...
add_some_foods_btn = tk.Radiobutton(options_frame, text=features[3], value=features[3], variable=choice)
add_some_foods_btn.grid(row=3, column=0)
analyze_btn = tk.Radiobutton(options_frame, text=features[4], value=features[4], variable=choice)
analyze_btn.grid(row=4, column=0)
quit_btn = tk.Radiobutton(options_frame, text=features[5], value=features[5], variable=choice)
